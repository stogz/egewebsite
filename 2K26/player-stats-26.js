/* ═══════════════════════════════════════════════════════════════
   ...
   leaders:[] on a regular/playoffs/totals row → marks specific stat keys
              as a league leader (shown italicized), e.g. leaders:['ppg',
              'fgp']. Manual only — never computed automatically. See
